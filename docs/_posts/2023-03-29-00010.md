...
- [ ] [Search - Angular - GitHub](https://github.com/search?q=Angular&type=repositories)
  - [x] [Commit Message Guidelines by Angular](https://github.com/angular/angular/blob/22b96b9/CONTRIBUTING.md#-commit-message-guidelines)
  - [x] [Commit Message Guidelines by AngularJS (archived)](https://github.com/angular/angular.js/blob/master/DEVELOPERS.md#-git-commit-guidelines)

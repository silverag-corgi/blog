...
- [x] [angular.js/DEVELOPERS.md at master · angular/angular.js](https://github.com/angular/angular.js/blob/master/DEVELOPERS.md#-git-commit-guidelines)
- [x] [angular/CONTRIBUTING.md at 22b96b9 - angular/angular](https://github.com/angular/angular/blob/22b96b9/CONTRIBUTING.md#-commit-message-guidelines)

### 6.2. Conventional Commits

- [ ] [Git コミットメッセージ 規約 - Google 検索](https://www.google.com/search?q=Git+コミットメッセージ+規約)
  - [x] [Conventional Commits 1.0.0 - Conventional Commits](https://www.conventionalcommits.org/ja/v1.0.0/)
  - [x] [About - Conventional Commits](https://www.conventionalcommits.org/en/about/)
    - [x] [conventional-changelog/conventional-changelog-cli - GitHub](https://github.com/conventional-changelog/conventional-changelog/tree/master/packages/conventional-changelog-cli)
    - [x] [joselitofilho/go-conventional-commits - GitHub](https://github.com/joselitofilho/go-conventional-commits)
    - [x] [leodido/go-conventionalcommits - GitHub](https://github.com/leodido/go-conventionalcommits)
    - [x] [goreleaser/chglog - GitHub](https://github.com/goreleaser/chglog)
    - [x] [commitizen-tools/commitizen - GitHub](https://github.com/commitizen-tools/commitizen)
      - [x] [Commitizen documentation](https://commitizen-tools.github.io/commitizen/)
    - [x] [marcocesarato/php-conventional-changelog - GitHub](https://github.com/marcocesarato/php-conventional-changelog)
    - [x] [semantic-release/semantic-release-cli - GitHub](https://github.com/semantic-release/cli)
    - [x] [semantic-release/semantic-release - GitHub](https://github.com/semantic-release/semantic-release)
    - [x] [python-semantic-release/python-semantic-release - GitHub](https://github.com/python-semantic-release/python-semantic-release)
      - [x] [Python Semantic Release - python-semantic-release 7.32.2 documentation](https://python-semantic-release.readthedocs.io/en/latest/)
    - [x] [jgoodman8/pyhist - GitHub](https://github.com/jgoodman8/pyhist)
    - [x] [PSanetra/git-semver - GitHub](https://github.com/PSanetra/git-semver)
    - [x] [adamtabrams/change - GitHub](https://github.com/adamtabrams/change)
    - [x] [bvieira/sv4git - GitHub](https://github.com/bvieira/sv4git)
    - [x] [chaaz/versio - GitHub](https://github.com/chaaz/versio)
    - [x] [tomasbjerre/git-changelog-command-line - GitHub](https://github.com/tomasbjerre/git-changelog-command-line)
    - [x] [tomasbjerre/git-changelog-lib - GitHub](https://github.com/tomasbjerre/git-changelog-lib)
    - [x] [cocogitto/cocogitto - GitHub](https://github.com/cocogitto/cocogitto)
    - [x] [gembaadvantage/uplift - GitHub](https://github.com/gembaadvantage/uplift)

### 6.3. GitHub Programming Language Ranking

- [ ] [GitHub Programming Language Ranking - Google 検索](https://www.google.com/search?q=GitHub+Programming+Language+Ranking)
  - [x] [The top programming languages - The State of the Octoverse](https://octoverse.github.com/2022/top-programming-languages#Frame%201776)

### 6.4. conventional-changelog-cli

- [ ] [conventional-changelog-cli - Google 検索](https://www.google.com/search?q=conventional-changelog-cli)
  - [ ] [Conventional CommitでGemのCHANGELOGをコミットから自動作成する - セットプチフォッカ](https://ikmbear.hatenablog.com/entry/20220208/1644282000)
  - [ ] [conventional-changelog-cliでCHANGELOGを自動生成してみる - WP-kyoto](https://wp-kyoto.net/generate-changelog-by-conventional-changelog-cli/)
- [ ] [Ubuntu npm インストール - Google 検索](https://www.google.com/search?q=Ubuntu+npm+インストール)
  - [ ] [【Ubuntu版】Node.js インストール方法をまとめ - Inno-Tech-Life](https://inno-tech-life.com/dev/js/nodejs_ubuntu/)

### 6.5. github-changelog-generator

- [ ] [changelog generator issue pr - Google 検索](https://www.google.com/search?q=changelog+generator+issue+pr)
  - [x] [github-changelog-generator/github-changelog-generator](https://github.com/github-changelog-generator/github-changelog-generator)

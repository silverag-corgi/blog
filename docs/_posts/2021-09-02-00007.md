...
2. GitHubがmasterブランチへのプッシュを検知する
3. GitHubがGitHubPagesに組み込まれたJekyll(セーフモードON)でビルドする
4. GitHubがGitHubPagesに生成物をデプロイする
...
9. GitHubがGitHubPagesに生成物をデプロイする
...
[ブログ公開までのワークフロー](#変更後セーフモードoffサポートされていないプラグイン使用)
の2.～8.を自動化する。

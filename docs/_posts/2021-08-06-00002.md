...
layout: post
published: true
title: Jekyllでブログを生成してGitHubPagesで公開してみました
slug: jekyllでブログを生成してgithubpagesで公開してみました
pub_at: 2021/08/06 13:00:00
upd_at: 2024/05/25 11:00:00
image: /assets_of_posts/00002/github.JPG
toc: true
categories:
  - 技術日記
tags:
...
![サンプルサイト01](
{{ '/assets_of_posts/00002/sample_site_01.JPG' | relative_url }})
{: .post-content-image }
...
![サンプルサイト02](
{{ '/assets_of_posts/00002/sample_site_02.JPG' | relative_url }})
{: .post-content-image }
...
ローカルサーバでは動作しますが、GitHubPagesではJekyllがセーフモードとやらになってしまうらしく、動作しないとのこと。
...
![サンプルサイト03](
{{ '/assets_of_posts/00002/this_site.JPG' | relative_url }})
{: .post-content-image }

なぜ大変だったかというと、自分はJekyll、GitHubPages、Liquidなどを今まで触ったことがなかったので、
新たに基礎から理解する必要がありました。
